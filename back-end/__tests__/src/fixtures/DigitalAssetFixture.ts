...
import { IDigitalAsset } from '../../../src/core/entities';
import { IDigitalAssetMarketData } from '../../../src/core/use-cases/integration/digitalAsset';

export function makeFakeDigitalAsset (overrides: Partial<IDigitalAsset> = {}): IDigitalAsset {
  const digitalAssetParams: IDigitalAsset = {
    assetId: faker.random.alphaNumeric(7),
    symbol: faker.random.alpha({count: 3, upcase: false}),
    name: faker.random.word(),
    image: faker.random.image(),
    currentPrice: faker.datatype.float(),
    marketCap: faker.datatype.number(),
    marketCapRank: faker.datatype.number(),
    fullyDilutedValuation: faker.datatype.number(),
    totalVolume: faker.datatype.number(),
    high24Hour: faker.datatype.number(),
    low24Hour: faker.datatype.number(),
    priceChange24Hour: faker.datatype.number(),
    priceChangePercentage: faker.datatype.number(),
    marketCapChange24Hour: faker.datatype.number(),
    marketCapChangePercentage: faker.datatype.number(),
    circulatingSupply: faker.datatype.number(),
    totalSupply: faker.datatype.number(),
    maxSupply: faker.datatype.number(),
    ath: faker.datatype.number(),
    athChangePercentage: faker.datatype.number(),
    athDate: faker.datatype.datetime().toTimeString(),
    atl: faker.datatype.number(),
    atlChangePercentage: faker.datatype.number(),
    atlDate: faker.datatype.datetime().toTimeString(),
...
export async function fakeFetchDigitalAssets(): Promise<IDigitalAssetMarketData[]> {
  return [{
    "id": "bitcoin",
    "symbol": "btc",
    "name": "Bitcoin",
