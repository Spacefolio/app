...
import { coindataService } from "../assets/coindata.service";
...
import { ITransaction, saveTransactionViewItems, getConversionRate } from "../transactions";
import { User } from "../users";
import { ExchangeAccount } from "../_helpers/db";
import { IExchangeAccountRequest, IPortfolioDataView, IPortfolioItemView, IOpenOrderItemView, ITransactionItemView } from "../../../types";
import { IExchangeAccountDocument, IHoldingSnapshot, IHoldingsHistory, ITimeslices, IHoldingSlice, ITimeslice } from "./exchange.model";
import { ccxtService } from "./_helpers";
...
async function createPortfolioItems(
	...
	for (var i = 0; i < balances.length; i++) {
		...
		let logoUrl = await getCoinLogo(balances[i].symbol);
