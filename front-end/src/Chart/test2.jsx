...
var CandleStickChartWithDarkTheme = (props) => {

    const { type, data: initialData, width, ratio, height: fakeheight} = props;

    const margin = { left: 0, right: 50, top: 0, bottom: 36 };
    const height = fakeheight - margin.bottom;
    ...
    return (
      ...
      >
        ...
        <Chart
          ...
          yExtents={(d) => d.volume}
          height={height/2}
          origin={(w, h) => [0, (height/2)-margin.bottom]}
        >
          {/* <YAxis
            axisAt="left"
            orient="left"
