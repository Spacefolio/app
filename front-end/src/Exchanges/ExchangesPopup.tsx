...
export const ExchangesPopup: React.FC<ExchangesPopupProps> = ({}) => {
  ...
  return (
    <div className="exchange-popup-wrapper">
      <div className="exchange-popup-inner-wrapper center-my-children-column">
        <div className="my-exchanges-wrapper ">
          <div className="my-exchanges-label-container ">
        ...
        <div className="add-exchange-wrapper center-my-children">
          <AddExchangeForm />
        </div>
      </div>
    </div>
